...
async function seed() {
  ...
  const products = await Promise.all([
    ...
    Product.create({ artist: 'Cindy Sherman', title: 'Still from an Untitled Film', description: 'A photo', price: 50, quantity: 40, categoryId: 1, imgUrl: 'http://web.guggenheim.org/exhibitions/chamberlain/images/1984_x.2011.127_chamberlain_a.jpg' }),
